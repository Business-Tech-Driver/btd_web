    ...
    <section id="driver-mode" className="py-32 bg-[#08152E] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          <a
            href="#contacto"
            className="inline-block bg-[#C7A86A] text-white px-8 py-4 rounded-full hover:bg-[#b89960] transition-colors shadow-lg shadow-[#C7A86A]/30 hover:shadow-[#C7A86A]/50"
          >
            Activa el Driver Mode
          </a>
        </motion.div>
      </div>
    </section>
